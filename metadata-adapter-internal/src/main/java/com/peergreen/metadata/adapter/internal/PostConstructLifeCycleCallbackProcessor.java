...
@LifeCycleCallbackProcessor("javax.annotation.PostConstruct")
public class PostConstructLifeCycleCallbackProcessor {
    ...
    public void handle(LifeCycleCallbackContext lifeCycleCallbackContext) {
        ...
        if (PostConstruct.class.getName().equals(lifeCycleCallbackContext.getAnnotation().getClassName())) {
